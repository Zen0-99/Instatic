#!/usr/bin/env python3
"""Dump ALL environment variables from the language server process - full output."""
import ctypes, ctypes.wintypes, sys, struct, subprocess
...
print(f'\nTotal env entries: {len([e for e in entries if e])}')
print('\n=== ALL ENV VARS ===')
